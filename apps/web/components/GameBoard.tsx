...
const BOARD_PROPERTIES: BoardProperty[] = [
  { id: 0,  name: 'GO',                    type: 'corner',   icon: '🎮' },
  { id: 1,  name: 'Salvador',              type: 'property', color: 'brown',      price: 60,  icon: '🏺', flag: '🇧🇷' },
  { id: 2,  name: 'Community Chest',       type: 'special',  icon: '📊' },
  { id: 3,  name: 'Rio de Janeiro',        type: 'property', color: 'brown',      price: 60,  icon: '🏔️', flag: '🇧🇷' },
  { id: 4,  name: 'Income Tax',            type: 'special',  icon: '📋' },
  ...
  { id: 7,  name: 'Chance',                type: 'special',  icon: '❓' },
  ...
  { id: 10, name: 'Jail / Just Visiting',  type: 'corner',   icon: '⚠️' },
  { id: 11, name: 'Rome',                  type: 'property', color: 'pink',       price: 140, icon: '🏛️', flag: '🇮🇹' },
  { id: 12, name: 'Electric Company',      type: 'property', color: 'utility',    price: 150, icon: '⚡' },
  { id: 13, name: 'Milan',                 type: 'property', color: 'pink',       price: 140, icon: '🏢', flag: '🇮🇹' },
  { id: 14, name: 'Venice',                type: 'property', color: 'pink',       price: 160, icon: '🛶', flag: '🇮🇹' },
  { id: 15, name: 'Munich Airport',        type: 'property', color: 'railroad',   price: 200, icon: '✈️', flag: '🇩🇪' },
  { id: 16, name: 'Frankfurt',             type: 'property', color: 'orange',     price: 180, icon: '🏢', flag: '🇩🇪' },
  { id: 17, name: 'Community Chest',       type: 'special',  icon: '🅿️' },
  { id: 18, name: 'Munich',                type: 'property', color: 'orange',     price: 180, icon: '🍺', flag: '🇩🇪' },
  { id: 19, name: 'Berlin',                type: 'property', color: 'orange',     price: 200, icon: '🏛️', flag: '🇩🇪' },
  { id: 20, name: 'Free Parking',          type: 'corner',   icon: '🅿️' },
  { id: 21, name: 'Shanghai',              type: 'property', color: 'red',        price: 220, icon: '🏙️', flag: '🇨🇳' },
  { id: 22, name: 'Chance',                type: 'special',  icon: '❓' },
  ...
  { id: 28, name: 'Water Works',           type: 'property', color: 'utility',    price: 150, icon: '💧' },
  { id: 29, name: 'Versailles',            type: 'property', color: 'yellow',     price: 280, icon: '⛲', flag: '🇫🇷' },
  { id: 30, name: 'Go To Jail',            type: 'corner',   icon: '🚔' },
  { id: 31, name: 'London',                type: 'property', color: 'green',      price: 300, icon: '🎡', flag: '🇬🇧' },
  { id: 32, name: 'Manchester',            type: 'property', color: 'green',      price: 300, icon: '🏟️', flag: '🇬🇧' },
  { id: 33, name: 'Community Chest',       type: 'special',  icon: '🎁' },
  { id: 34, name: 'Liverpool',             type: 'property', color: 'green',      price: 320, icon: '🎸', flag: '🇬🇧' },
  { id: 35, name: 'JFK Airport',           type: 'property', color: 'railroad',   price: 200, icon: '✈️', flag: '🇺🇸' },
  { id: 36, name: 'Chance',                type: 'special',  icon: '❓' },
  { id: 37, name: 'San Francisco',         type: 'property', color: 'dark-blue',  price: 350, icon: '🌉', flag: '🇺🇸' },
  { id: 38, name: 'Luxury Tax',            type: 'special',  icon: '💰' },
  { id: 39, name: 'New York',              type: 'property', color: 'dark-blue',  price: 400, icon: '🗽', flag: '🇺🇸' },
];
