...
export function FeaturesSection() {
  ...
  return (
    <section ref={targetRef} className="relative h-[200vh] bg-background">
      <div className="sticky top-0 h-screen flex flex-col items-center overflow-hidden pt-12 pb-24">
        ...
        <motion.div style={{ x }} className="flex gap-8 px-4 w-full">
          {features.map((feature, i) => (
            <div 
              key={i} 
              className="w-[85vw] md:w-[500px] shrink-0 h-[500px] glassmorphism rounded-3xl border border-white/10 p-10 flex flex-col justify-between group hover:border-white/20 transition-colors relative overflow-hidden"
            >
              ...
              <div>
                ...
                <p className="text-xl text-slate-400 leading-relaxed">{feature.desc}</p>
              </div>
