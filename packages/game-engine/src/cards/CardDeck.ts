import type { CardDefinition } from '@richup/shared-types';
...
export class CardDeck {
  ...
  private heldCards: CardDefinition[] = []; // Get Out of Jail Free cards held by players
  ...
  serialize(): { remaining: number; heldCardIds: string[] } {
    return {
